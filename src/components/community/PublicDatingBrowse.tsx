  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
      <div className="flex flex-col gap-5 border-b border-white/10 pb-6 sm:flex-row sm:items-end sm:justify-between">
        <div><p className="text-xs font-semibold uppercase tracking-[0.2em] text-rose-300">Public classifieds</p><h1 className="mt-2 font-serif text-3xl font-semibold text-white">Dating posts</h1><p className="mt-3 max-w-2xl text-sm leading-6 text-slate-400">Browse active summaries from members with public profiles. Sign in to view member-only details, reply, save, create, or report.</p></div>
