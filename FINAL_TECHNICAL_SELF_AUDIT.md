...
| Public profiles/community | PASS for minimized scope | Explicit-public active profiles only; safe serializer and deterministic pagination |
...
- `npm run test`: 39 security boundary tests pass.
