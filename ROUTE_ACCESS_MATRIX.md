...
| `/photos`, `/videos`, `/album/[id]`, `/video/[id]` | Public only for approved PUBLIC media | Must use server moderation + visibility checks and signed/approved delivery | Never expose raw private object keys or unapproved media | Planned; routes not yet enabled |
