...
| `/search` | Public minimized results; richer authenticated results | Guest uses `/api/public/search`; members use block-aware `/api/search` | Guests receive explicit-public profiles, approved public media/albums and active ads from public authors only | Implemented |
